    ...
    <div class="legal-container">
      ...
      <div class="legal-content">
        <section>
          <h2>Quiénes somos</h2>
          <div class="info-box">
            <p><strong>Petru Workout</strong></p>
        ...
        <section>
          <h2>Contáctenos</h2>
          <p>Siempre nos complace escucharte (¡incluso si es una queja!). Siempre estamos agradecidos por el tiempo que nos dedicas, brindándonos el conocimiento que necesitamos para asegurar que nuestros clientes estén completamente satisfechos. Queremos que regrese al sitio y nos recomiende a sus amigos y familiares. Si tiene alguna pregunta o comentario sobre esta declaración, o si desea que dejemos de procesar su información, no dude en ponerse en contacto con el servicio de atención al cliente <a href="mailto:info.petrusw@gmail.com">info.petrusw@gmail.com</a>, quien estará encantado de responder cualquier pregunta que pueda tener.</p>
        </section>
      </div>
